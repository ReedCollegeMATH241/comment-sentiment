...
**Hacker News** (HN) is a news aggregator focused on startups, science, and technology. Hacker News comments are well-suited to investigation for these reasons:

* HN is an English-language site.

* Site policy and culture keeps discussion relatively civil.

* By Internet standards, posts are long and well-edited.
...
1000 recent comments from Hacker News were downloaded using a Python script which made use of the package `hackernews-scraper`. That script is included in this project. The comments are in JSON format.
...
The bulk of the code has been run. Here is the list of the top stories by level of positive sentiment.
